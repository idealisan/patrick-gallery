...
func (a *App) RegisterRoutes(r *gin.Engine) {
	...
	api.Use(a.AuthGuard())
	{
		...
		api.DELETE("/stacks", a.handleStacksDelete)
		...
		api.GET("/assets/duplicates", a.handleDuplicatesList)
		...
		api.GET("/duplicates", a.handleDuplicatesList)
		api.POST("/duplicates/resolve", a.handleDuplicatesResolve)
		api.DELETE("/duplicates", a.handleDuplicatesDeleteAll)
